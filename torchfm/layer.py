...
class GraphConvolution(Module):
    ...
    def __init__(self, in_features, out_features, initial_W, bias=True):
        ...
        self.reset_parameters(initial_W)

    def reset_parameters(self, initial_W):
    ...
    def forward(self, input, norm_adj):
        # H(0) = input = X
